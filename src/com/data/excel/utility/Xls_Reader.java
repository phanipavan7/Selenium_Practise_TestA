...
//				String cellText = String.valueOf(cell.getNumericCellValue()); //Original
//				String cellText  = String.valueOf(cell.getStringCellValue()); //Added By Me
				String cellText = NumberToTextConverter.toText(cell.getNumericCellValue()); //taken from StackOVerflow
